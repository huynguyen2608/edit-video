"""Fingerprint chống trùng: biến đổi NHẸ và XÁC ĐỊNH theo video_id để mỗi bản xuất
khác nhau đôi chút (né bộ lọc trùng nội dung của nền tảng) mà vẫn giữ chất lượng.
...
def deltas_for(video_id: str, strength: float = 1.0) -> dict:
    ...
    speed ±2%, brightness ±0.04, saturation ±0.06, zoom ±2%, có thể lật ngang.
    """
